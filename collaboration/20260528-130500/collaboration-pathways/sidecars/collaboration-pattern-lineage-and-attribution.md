# Collaboration Pattern Lineage and Attribution
...
| 3rd | 2026-05-26 | Originator → person-b | Attestation validation instance |
| 4th | 2026-05-26 | Originator → person-c | Deal Flow application seeding |
| **5th** | **2026-05-28** | **Originator → the open MikeOSS project and team** | **Open invitation + first canonical Pathways encoding of the collaboration-bundle technique** |
...
Prior instances already carried instance-scoped `Collaboration.*` pathways. This bundle does not erase them; it canonizes the technique they practiced and makes it self-describing. See [`../canon/COLLABORATION_BUNDLE_TECHNIQUE.md`](../canon/COLLABORATION_BUNDLE_TECHNIQUE.md) §6.
...
Fork allowed. Attribution required. Revocation scope max `self_only`.
